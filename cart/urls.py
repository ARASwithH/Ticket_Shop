...
urlpatterns = [
    ...
    path('apply-discount/<int:ord_id>/', views.ApplyDiscountView.as_view(), name='apply_discount'),
    path('creat_order/', views.CreatOrderView.as_view(), name='creat_order'),
    path('delete-discount/<int:ord_id>/', views.DeleteDiscountView.as_view(), name='delete_discount'),
